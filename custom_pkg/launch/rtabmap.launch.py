...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='zed_left_camera_optical_frame',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/zed/zed_node/rgb/image_rect_color',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/zed/zed_node/depth/depth_registered', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/zed/zed_node/odom',  description='Odometry topic name.'),
